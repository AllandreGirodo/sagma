...
void main() {
  ...
  testWidgets(
    'Deve exibir ConfigErrorView quando .env estiver faltando (Simulação)',
    ...
    skip: true, // Teste de integração: requer --dart-define=ENV=inexistente e Firebase real. Executar com: flutter test integration_test/
  );
}