...
**Fonte: Autores (2026).**
<br>
A presente figura evidencia a tela inicial de boas-vindas, usada para apresentar o aplicativo e orientar a primeira interação do cliente.

**Figura 2. Tela Onboarding Historico Completo**
<br>
![Tela Onboarding Historico Completo](complementares/client_ui/Tela_Onboarding_Historico_Completo.png)
<br>
**Fonte: Autores (2026).**
<br>
A presente figura mostra a continuidade da apresentação inicial, destacando o histórico e a lógica de acompanhamento das interações do cliente.
...
<br>
![Tela Agendamentos Cliente Pendente à Confirmar](complementares/Tela_Agendamentos_Cliente_Pendente_%C3%A0_Confirmar.png)
<br>
**Fonte: Autores (2026).**
<br>
...
<br>
![Tela Perfil Cliente Consentimento LGPD Visual](complementares/client_ui/Tela_Perfil_Cliente_Consentimento_LGPD_Visual.png)
<br>
**Fonte: Autores (2026).**
<br>
...
<br>
![Tela Esqueci Senha Cliente](complementares/client_ui/Tela_Esqueci_Senha_Cliente.png)
<br>
**Fonte: Autores (2026).**
<br>
...
**Figura 24. Tela Health Check Serviços Nuvem App**
<br>![Tela Health Check Serviços Nuvem App](complementares/Tela_Health_Check_Servicos_Nuvem_App.png)
<br>
**Fonte: Autores (2026).**
...
**Figura 25. Tela Health Check Serviços Nuvem App**
<br>![Tela Health Check Serviços Nuvem App](complementares/Tela_Health_Check_Servicos_Nuvem_App.png)
<br>**Fonte: Autores (2026).**
<br>A presente figura exibe o health check dos serviços na nuvem, utilizado para monitoramento e manutenção do aplicativo.

---**Figura 26. Tela Health Check Serviços Nuvem App**
Tela_Health_Check_Servicos_Nuvem_App.png
<br>
**Fonte: Autores (2026).**
<br>
